<?php
	...
	require(__INCLUDES__ . '/examples/header_main.inc.php');
?>
<div style="text-align: center; width: 100%;">
	<div style="text-align: left; margin: 0px auto 0px auto; width: 830px;">
		...
		<div class="instructions_main" style="width: 770px;">
			...
			<a href="<?php _p(__VIRTUAL_DIRECTORY__); ?>/examples/code_generator/intro.php" class="bodyLink" style="font-weight: bold;">Basic CodeGen &gt; About the Database</a>
...
<?php
				...
				foreach ($objExampleCategory as $strKey => $strValue) {
					if (is_numeric($strKey)) {
						...
						printf('<li><a href="%s/examples%s" class="bodyLink">%s</a></li>', __VIRTUAL_DIRECTORY__, substr($strValue, 0, $intPosition), substr($strValue, $intPosition + 1));
					}
				}
