...
///////////////////////////////////////////////////////
	...
	Copy the following files to the following locations
		...
		includes/qcodo_core/QApplication.class.php-dist => includes/QApplication.class.php
		includes/qcodo_core/configuration.inc.php-dist  => includes/configuration.inc.php
