<?php
	class Examples {
		...
		public static function PageLinks() {
						...
						if (is_numeric($strKey)) {
							...
							if (!$blnFound) {
								if (strpos(QApplication::$ScriptName, $strScriptName) !== false) {
									...
									$strPrevious = sprintf('<b><a href="%s/examples%s" class="headingLink">&lt;&lt; %s</a></b>',
										__VIRTUAL_DIRECTORY__, $strScriptName, $strDescription);
								}
							} else if (!$strNext) {
								$strNext = sprintf('<b><a href="%s/examples%s" class="headingLink">%s &gt;&gt;</a></b>',
									__VIRTUAL_DIRECTORY__, $strScriptName, $strDescription);
							}
						}
					}
			...
			$strToReturn .= ' &nbsp; | &nbsp; ';
			$strToReturn .= sprintf('<b><a href="%s/examples/index.php/%s" class="headingLink">Back to Main</a></b>',
				__VIRTUAL_DIRECTORY__, $intPartId);
			$strToReturn .= ' &nbsp; | &nbsp; ';
	...
	class ExamplesBaseForm extends QForm {
