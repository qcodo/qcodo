<?php
	 ...
	 * <input type="password">, <input type="hidden"> or <textarea> depending on
	 * the TextMode (see below).
	 *
	 * @package Controls
	 *
	 ...
	 * @property string $TextMode can be "SingleLine", "MultiLine", "Hidden" and "Password".
